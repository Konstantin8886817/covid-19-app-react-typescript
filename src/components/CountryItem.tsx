...
import { Country, PropsItem, ContentPropsItem } from '../iResponseData';
...
const ListContent = styled.div<ContentPropsItem>`
    background-color:  ${props => props.isActive ? "#9ce0d047" : "#9ce0d0"} ;
    margin: 5px;
    padding: 10px 0;
`;
